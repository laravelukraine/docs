...
- [Теги кешу](#cache-tags)
    - [Збереження елементів кешу з тегами](#storing-tagged-cache-items)
    - [Доступ до елементів кешу з тегами](#accessing-tagged-cache-items)
    - [Видалення елементів кешу з тегами](#removing-tagged-cache-items)
