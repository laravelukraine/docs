...
Ви можете скористатися методом `forward`, щоб перенаправити завдання з однієї черги в іншу чергу та / або підключення. Це корисно, коли потрібно змінити інфраструктуру черг без зміни окремих завдань чи місць їх відправлення:
...
Ви також можете перенаправити кілька черг одразу, передавши масив:
...
Явне підключення, налаштоване на завданні, має перевагу над перенаправленим підключенням.
...
Якщо ви диспетчеризуєте завдання до черги SQS FIFO, не вказавши групу повідомлень, Laravel використає назву черги як ID групи повідомлень.
...
Щоб призупинити обробку завдань для кожної черги на кожному підключенні, скористайтеся опцією `--all`:
...
Щоб поновити обробку завдань для кожної черги на кожному підключенні, скористайтеся опцією `--all` з командою `queue:resume`:

```shell
php artisan queue:resume --all
```

Після поновлення черги воркери одразу почнуть обробляти з неї нові завдання. Поновлення всіх черг не поновлює черг, які були призупинені індивідуально. Зверніть увагу: призупинення черги не зупиняє самого процесу воркера - воно лише не дає воркеру брати нові завдання з указаної черги.
