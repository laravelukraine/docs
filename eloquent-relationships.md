...
- [Зв'язки «багато до багатьох»](#many-to-many)
    ...
    - [Визначення власних моделей проміжної таблиці](#defining-custom-intermediate-table-models)
        - [Автоматичне наповнення зв'язків Pivot](#automatically-hydrating-pivot-relationships)
...
Коли власна проміжна модель визначає зв'язки `belongsTo` для оголошувальної та зв'язаної моделей, ви можете викликати `chaperone`, щоб автоматично гідратувати ці зв'язки на кожній проміжній моделі. Це уникає додаткових запитів при доступі до моделей через проміжну:
...
Eloquent спробує вивести назви зв'язків проміжної моделі. Якщо ваша проміжна модель використовує нестандартні назви, передайте назви оголошувального та зв'язаного зв'язків до `chaperone`:
