...
### Скоповані файлові системи, системи лише для читання та системи зі зчитуванням
...
Диски зі зчитуванням дозволяють мігрувати файли між дисками без простою. При читанні файлу Laravel спершу перевіряє основний диск. Якщо файл існує лише на резервному диску, Laravel зчитує файл з резервного диска й копіює його на основний диск для майбутніх запитів:
...
Запис і перегляд каталогів орієнтовані на основний диск. Перевірка наявності файлів і метаданих використовує будь-який диск без копіювання файлів на основний диск. Якщо копіювання файлу з резервного диска на основний зазнає невдачі, читання все одно завершується успішно за замовчуванням. Щоб натомість викидати виняток, встановіть опцію конфігурації `throw_on_promotion_failure` у `true`.
