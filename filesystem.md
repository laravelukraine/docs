...
Також ви можете описати опцію `report` у масиві конфігурації вашого диска. Коли ця опція має значення `true`, Laravel логуватиме базовий виняток через обробник винятків вашого застосунку, якщо операція запису провалиться, не викидаючи виняток і не перериваючи повернення значення операції запису:
