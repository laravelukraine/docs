...
Якщо ви хочете, щоб всі події бродкастингу використовували одну й ту саму чергу без налаштування кожного класу події окремо, ви можете натомість [направити контракт `ShouldBroadcast` до черги](/docs/{{version}}/queues#queue-routing).
