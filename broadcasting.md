...
Якщо ви хочете, щоб усі події бродкастингу використовували одну й ту саму чергу без налаштування кожного класу події, ви можете натомість [направити контракт `ShouldBroadcast` до черги](/docs/{{version}}/queues#queue-routing).
