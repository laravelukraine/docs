...
Валідатор `dns` виконує реальний DNS-запит, щоб переконатися, що домен адреси має дійсний MX-запис. Він не визначає, чи існує окрема поштова скринька.

Оскільки ваші тести не повинні покладатися на живі DNS-запити, ви можете використати метод `Validator::fakeDnsLookups`, щоб [підмінити DNS-запити](#rule-active-url), поки інші валідації, такі як `rfc`, продовжують виконуватися:
