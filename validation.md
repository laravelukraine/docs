...
Валідатор `dns` виконує справжній DNS-запит, щоб підтвердити, що домен адреси має дійсний MX-запис. Він не визначає, чи існує окрема поштова скринька.

Оскільки ваші тести не повинні покладатися на живі DNS-запити, ви можете використати метод `Validator::fakeDnsLookups`, щоб [імітувати DNS-запити](#rule-active-url), тоді як інші запитані валідації, такі як `rfc`, продовжують виконуватися:
...
Це дозволяє вашому застосунку продовжувати використовувати існуючі правила валідації під час тестування:
