...
Оскільки ваші тести не повинні покладатися на живі DNS-запити, ви можете використати метод `Validator::fakeDnsLookups`, щоб [імітувати DNS-запити](#rule-active-url), тоді як інші запитані валідації, такі як `rfc`, продовжуватимуть виконуватися:
