...
Валідатор `dns` виконує справжній DNS-запит, щоб підтвердити, що домен адреси має дійсний MX-запис. Він не визначає, чи існує конкретна поштова скринька.

Оскільки ваші тести не повинні залежати від реальних DNS-запитів, ви можете скористатися методом `Validator::fakeDnsLookups`, щоб [підмінити DNS-запити](#rule-active-url), тоді як усі інші запитувані валідації, такі як `rfc`, продовжать виконуватися:
