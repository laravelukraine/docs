...
- Стратегія `log` призначатиме воркерів за логарифмом кількості завдань у черзі. Це запобігає тому, щоб значно більша черга отримувала непропорційно велику частку воркерів.
