...
#### Оновлення читабельних файлів середовища

Під час оновлення читабельного зашифрованого файлу середовища Laravel зберігає незмінені значення та видаляє змінні, яких більше немає у вихідному файлі середовища:

```shell
php artisan env:encrypt --readable --key=3UVsEgGVK36XN82KKeyLFMhvosbZN1aF
```

Зашифрований файл буде створено, якщо він не існує. Під час оновлення наявного файлу надайте той самий ключ шифрування та шифр, які використовувалися для його створення. Якщо файл не вдається розшифрувати, команда завершиться з помилкою, не перезаписуючи його.

Щоб знову зашифрувати всі значення, використовуйте опцію `--force`. Це дозволяє змінити ключ шифрування або замінити недійсний зашифрований файл:
