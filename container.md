...
Для прив'язок, які залежать від довільної умови, можна використовувати атрибут `BindWhen`. Замикання може отримувати контейнер і має повертати `true`, коли прив'язку слід застосувати. Атрибути `Bind` і `BindWhen` оцінюються в порядку їх оголошення:
