...
Якщо ви хочете, щоб усі ваші слухачі у черзі використовували ту саму чергу без налаштування кожного класу слухача окремо, можете натомість [спрямувати контракт `ShouldQueue` у чергу](/docs/{{version}}/queues#queue-routing).
