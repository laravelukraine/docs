...
Якщо ви хочете, щоб усі ваші слухачі черги використовували одну й ту саму чергу без налаштування кожного класу слухача окремо, ви можете натомість [спрямувати контракт `ShouldQueue` у чергу](/docs/{{version}}/queues#queue-routing).
