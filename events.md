...
Якщо ви хочете, щоб усі ваші слухачі черги використовували одну чергу без налаштування кожного класу слухача окремо, ви можете натомість [направити контракт `ShouldQueue` до черги](/docs/{{version}}/queues#queue-routing).
