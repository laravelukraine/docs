...
Метод `chunkBy` розбиває колекцію на декілька менших колекцій, групуючи сусідні елементи, які мають однакове значення для заданого ключа або колбека. Наприклад, ви можете згрупувати сусідні продукти, які мають спільного батька:
