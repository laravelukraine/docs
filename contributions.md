...
Щоб заохотити активну співпрацю, Laravel наполегливо радить надсилати pull request, а не просто повідомлення про помилки. Кожен pull request розглядається лише тоді, коли його позначено як «ready for review» (тобто не в стані «draft») і всі тести для нових можливостей проходять. Застарілий неактивний pull request, залишений у стані «draft», буде закрито за кілька днів.
