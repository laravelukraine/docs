...
Щоб заохотити активну співпрацю, Laravel наполегливо радить надсилати pull request, що виправляють проблеми, а не GitHub issue. GitHub issue вимкнено в більшості наших власних пакетів.

Якщо ви виявили проблему, створіть pull request, що її виправляє. Ваш pull request має містити заголовок і чіткий опис проблеми та її розв'язання. Також варто додати якомога більше доречної інформації та приклад коду, що демонструє проблему. Мета pull request - полегшити вам і іншим розуміння проблеми та перевірку виправлення.

Якщо ви не знаєте, як виправити проблему, опишіть її кодинг-агенту і використайте його для спроби створити pull request.
