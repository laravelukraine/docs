...
Щоб заохотити активну співпрацю, Laravel наполегливо радить надсилати pull request, які розв'язують проблеми, а не створювати issue на GitHub. Issue на GitHub вимкнено для більшості наших офіційних пакетів.

Якщо ви виявили проблему, створіть pull request, який її вирішує. Ваш pull request має містити заголовок і чіткий опис проблеми та її розв'язання. Також варто додати якомога більше доречної інформації та приклад коду, що демонструє проблему. Мета pull request - полегшити вам і іншим розуміння проблеми та перевірку виправлення.

Якщо ви не знаєте, як виправити проблему, опишіть її AI-агенту й скористайтеся ним, щоб створити pull request.

Кожен pull request розглядається лише тоді, коли його позначено як «ready for review» (тобто не в стані «draft») і всі тести для нових можливостей проходять. Застарілий неактивний pull request, залишений у стані «draft», буде закрито за кілька днів.
...
Ми цінуємо кожен pull request, надісланий до Laravel. Однак значні внески, здебільшого згенеровані AI без вдумливого перегляду й осмислення людиною, неприйнятні.

Якщо ви вирішили скористатися AI-інструментами для підготовки великих або складних внесків до фреймворку, отриманий код **обов'язково** має бути ретельно переглянутий, протестований і зрозумілий вам перед надсиланням.

Опис pull request **обов'язково** має бути написаний цілком контриб'ютором. Pull request з описом, згенерованим AI, буде закрито.

**Масового створення issue чи pull request, повністю згенерованих AI, ми не терпітимемо.** Такий pull request буде закрито без розгляду, а користувача, який його надіслав, може бути заблоковано в репозиторії.

Ми заохочуємо контриб'юторів ознайомлюватися з наявною кодовою базою, взаємодіяти зі спільнотою та надсилати такий pull request, який відображає їхнє власне розуміння й уважне осмислення проблеми, яку вони розв'язують.
...
Не хвилюйтеся, якщо стиль вашого коду не бездоганний! [StyleCI](https://styleci.io/) автоматично зіллє всі виправлення стилю до репозиторію Laravel після того, як ваш pull request буде злито. Це дозволяє нам зосередитися на змісті внеску, а не на стилі коду.
...
- Поведінки, яку можна обґрунтовано вважати домаганням, ми не терпітимемо.
