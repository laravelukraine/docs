...
Щоб заохотити активну співпрацю, Laravel наполегливо радить надсилати pull request, які розв'язують проблеми, а не створювати issue на GitHub. Issue на GitHub вимкнено в більшості наших офіційних пакетів.

Якщо ви виявили проблему, створіть pull request, який її розв'язує. Ваш pull request має містити заголовок і чіткий опис проблеми та її розв'язання. Також варто додати якомога більше доречної інформації та приклад коду, що демонструє проблему. Мета pull request - полегшити вам і іншим розуміння проблеми та перевірку виправлення.

Якщо ви не знаєте, як виправити проблему, опишіть її агенту з кодування й скористайтеся ним, щоб створити pull request.
