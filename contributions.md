...
Щоб заохотити активну співпрацю, Laravel наполегливо радить надсилати pull request, які вирішують проблеми, а не створювати issue на GitHub. Issue на GitHub вимкнено в більшості наших основних пакетів.
...
Якщо ви не знаєте, як виправити проблему, опишіть її кодовому агенту й скористайтеся ним, щоб спробувати створити pull request.
...
**Масове створення issue чи pull request, повністю згенерованих AI, не буде терпітися.** Такий pull request закриється без розгляду, а користувача, який його надіслав, може бути заблоковано в репозиторії.
