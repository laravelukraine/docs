...
Метод `toSearchableEmbedding` вашої моделі має повертати вихідний текст, який Scout має перетворити на ембединг, або заздалегідь обчислений масив ембедингу:
