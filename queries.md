...
> [!NOTE]
> Умови векторної схожості наразі підтримуються на підключеннях PostgreSQL із розширенням `pgvector` та MariaDB 11.7 або новішої версії. Про те, як описувати векторні стовпці та індекси, читайте в [документації з міграцій](/docs/{{version}}/migrations#available-column-types).
